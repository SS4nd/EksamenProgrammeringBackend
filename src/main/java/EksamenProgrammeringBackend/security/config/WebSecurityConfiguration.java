package EksamenProgrammeringBackend.security.config;


import EksamenProgrammeringBackend.security.error.CustomOAuth2AccessDeniedHandler;
import EksamenProgrammeringBackend.security.error.CustomOAuth2AuthenticationEntryPoint;
...
public class WebSecurityConfiguration {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
    ...
    http.authorizeHttpRequests((authorize) -> authorize
            ...
            .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.GET, "/api/deltager/**")).permitAll() // Allow unauthenticated access to /api/deltager
            //.requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.POST, "/api/products")).permitAll()
            //.requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.GET, "/api/products")).permitAll()
            //.requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.PUT, "/api/products")).permitAll()
            //.requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.DELETE, "/api/products")).permitAll()
            //.requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.GET, "/api/products/*")).permitAll()
            //.requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.GET, "/api/products/{id}")).permitAll()
